...
/*
* Pré-Condição: requer uma referencia para a string do comando delf, uma referencia para uma instancia do TAD desenho, um arquivo txt e o tipo do delete (delf ou delf*).
