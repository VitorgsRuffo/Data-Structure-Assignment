...
/*
* Pré-Condição: requer uma referencia para a string do comando pnt?, uma referencia para uma instancia do TAD desenho, um arquivo txt e o tipo da pintura (pnt ou pnt*).
